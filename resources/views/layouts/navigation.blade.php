<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        {{-- (ตัวเลือก) ไปหน้าแก้ไข Bio ถ้ามี route ดังกล่าว --}}
                        @if (Route::has('profile.show-bio'))
                            <x-dropdown-link :href="route('profile.show-bio')">
                                {{ __('Edit Bio') }}
                            </x-dropdown-link>
                        @endif
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- Social Links (ลบได้ถ้าไม่ใช้) --}}
            <x-responsive-nav-link :href="route('social_media_links.index')" :active="request()->routeIs('social_media_links.*')">
                {{ __('Social Links') }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                @if (Route::has('profile.show-bio'))
                    <x-responsive-nav-link :href="route('profile.show-bio')">
                        {{ __('Edit Bio') }}
                    </x-responsive-nav-link>
                @endif
